...
<form method="post" enctype="multipart/form-data">	
	...
	<div class="form-horizontal">
			...
			<label class="control-label" for="inputEmail">Numéro Etudiant</label>
			<div class="controls">
			<input type="text" id="inputEmail" name="student_no" value="<?php if (isset($_POST['submit'])){echo $student_no;} ?>" placeholder=">Numéro Etudiant" required>
				&nbsp;	&nbsp; 	&nbsp; 	&nbsp;
	<?php if (isset($_POST['submit'])){?> 	<span class="label label-important"><?php echo $exist; ?></span><?php }?>
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="password" name="password" value="<?php if (isset($_POST['submit'])){echo $password;} ?>" placeholder="Mot de passe">
			</div>
		</div>
			<div class="control-group">
			<label class="control-label" for="inputPassword">Confirmation du mot de passe</label>
			<div class="controls">
			<input type="password" name="cpassword" value="<?php if (isset($_POST['submit'])){echo $cpassword;} ?>" placeholder="Confirmation du mot de passe" required>
		...
		<div class="control-group">
			<div class="controls">
			<button name="submit" type="submit" class="btn btn-info"><i class="icon-signin icon-large"></i>&nbsp;Valider</button>
			</div>
		</div>
    </div>
</div>
