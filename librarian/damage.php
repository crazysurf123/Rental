			   ...
			   <div class="alert alert-info">
						...
						<!--  -->
								    <ul class="nav nav-pills">
										...
										<li><a href="new_movies.php">Nouveaux Film</a></li>
										<li><a href="old_movies.php">Anciens Films</a></li>
										<li><a href="lost.php">DVD Perdu</a></li>
										<li class="active"><a href="damage.php">DVD Abbimé</a></li>
						...
						<h1>DVD Abbimé</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="add_movies.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Anciens Films</a></p>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from movie where status = 'Abbimé'")or die(mysql_error());
