			   ...
			   <div class="alert alert-info">
						...
						<!--  -->
								    <ul class="nav nav-pills">
										...
										<li  class="active"><a href="lost.php">DVD Perdu</a></li>
										<li><a href="damage.php">DVD Abbimé</a></li>
						...
						<h1>DVD Perdu</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="add_movies.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Ajouter un DVD</a></p>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from movie where status = 'Perdu'")or die(mysql_error());
