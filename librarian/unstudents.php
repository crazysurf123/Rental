			...
			<div class="span12">	
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Etudiant pas encore confirmé</strong>
                                </div>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from students where status = 'unactive' ")or die(mysql_error());
                                    ...
                                    <td width="150">
											<a  href="#confirm<?php echo $id; ?>" data-toggle="modal" class="btn btn-success"><i class="icon-check"></i>&nbsp;Confirmer</a>
