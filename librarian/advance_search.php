		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Liste des DVD</strong>
                                </div>
						<!--  -->
								    <ul class="nav nav-pills">
										<li   class="active"><a href="movies.php">Tous</a></li>
										<li><a href="new_movies.php">Nouveaux DVD</a></li>
										<li><a href="old_movies.php">Anciens DVD</a></li>
										<li><a href="lost.php">DVD Perdus</a></li>
										<li><a href="damage.php">DVD Abimé</a></li>
						...
						<h1>Liste des DVD</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="add_movies.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Ajout DVD</a></p>
                                ...
                                <tbody>
								  ...
								  $user_query=mysql_query("select * from movie where status != 'Archive' and movie_title LIKE  '%$title%'
